class Main extends Phaser.Scene {
    ...
    addOnePipe(x, y) {
        ...
        pipe.setOrigin(0, 0);
        this.pipes.add(pipe);
        pipe.body.velocity.x = -300- this.score * 5;
    ...
    addRowOfPipes() {
        var hole = Math.floor(Math.random() * 5) + 1- Math.floor(this.score / 10);
        this.score += 1;
    ...
    hitPipe() {
        ...
        // var gameOverText = this.add.text(200, 200, "Game Over\nFinal Score: " + this.score, { fontSize: 32, color: "red" });
